// DOMの読み込みが終わったらfunction()の中の処理を実行します。＄＝jQuqery(document,id等)の要素の指定。
$(document).ready(function () {

    // 「国語、英語、数学、理科、社会」の点数（入力値）を取得して合計点と平均点を出すロジック(関数)
    function score_indicate() {

      // 変数「subject_points」に「国語、英語、数学、理科、社会」の点数の配列を代入します。
      //変数サブジェクトポインツに国語から始まる教科の配列の点数文字列を数値に変換してhtmlのid valueに反映させている
    ...
    function get_achievement() {
      ...
      console.log(averageIndicate) //必要?
